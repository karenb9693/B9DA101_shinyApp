...
shinyUI(fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("Descriptive Analytics",
             tabsetPanel(
               tabPanel("Dataset Summary - Karen Byrne",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                                   selectInput(
               ...
               tabPanel("Graphical Representation - Karen Byrne",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                                   selectInput(
    ...
    tabPanel(
      ...
      tabsetPanel(
        tabPanel("Hypergeometric - Clinton Ngan",
                 fluidRow(
                   column(2,br(),
                          wellPanel(
                            selectInput("variable","Comparison Variable",choices = c(
                              "Cylinder" = "cyl",
                              "Gear" = "gear",
                              "Carbon" = "carb"), selected = "gear"),
                            numericInput("j", "Numbers of cars sampled", 5, min = 1, max = 32),
                            numericInput("a","Numbers of cars with selected variable (a)",2,
                                         min = 1,max = 32  ),
        ...
        tabPanel("Poisson - Karen Byrne",
                 fluidRow(
                   ...
                   column(
                     ...
                     p("The probability the amount of warpbreaks in the loom is less than",strong("y"),"is:"),
    ...
    tabPanel(
      ...
      tabsetPanel(
        tabPanel("Expenential Probability Model - Karen Byrne",
                 fluidRow(
                   column(
                     2,
                     br(),
        ...
        tabPanel(
          "Normal Distribution - James McAuley",
          fluidRow(
            column(2, br(),
                   #Three inputs. Two numeric for probability calc and 1 slider for histogram. Default value 1.
                   wellPanel(
                     numericInput("lower", "Lower", value = 15),
                     numericInput("upper", "Upper", value = 30)
                   )
            ),
    ...
    tabPanel("Hypothesis Test",
             tabsetPanel(
               tabPanel("One Population - Karen Byrne",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                                   selectInput("Alpha",h5("Alpha for Hypothesis Test"), choices = c("0.01", "0.05", "0.025")),
                                   selectInput("testtype",h5("Type of Hypothesis Test"),choices = c("less", "greater", "two.sided")),
                                   selectInput("iv",h5("Variable to be tester"),
               ...
               tabPanel("Two Population",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                                   selectInput("Alpha1", h5("Alpha for Hypothesis Test"),choices = c("0.01", "0.05", "0.025")),
                                   selectInput("testtype1",h5("Type of Hypothesis Test"),choices = c("less", "greater", "two.sided") )
                                 )
                          ),
                          column(
                            7,
             ...
             tabsetPanel(
               tabPanel("Linear Regression",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                                   sliderInput("sliderMPG","Input MPG for regression model?",min = 10,max = 35,value = 20),
               ...
               tabPanel("Poisson Regression - Karen Byrne",
                        fluidRow(
                          column(2, br(),
                                 wellPanel(
                          ...
                          column(10,br(),
                             ...
                             We will use the data provided to predict the amount of leave days a person takes based on some of their health and social factors."),
                                 ...
                                 p("Accuracy:"),
                                 verbatimTextOutput("accuracy", placeholder = TRUE),
                                 p("RMSE:"),
                                 verbatimTextOutput("RMSE", placeholder = TRUE),
